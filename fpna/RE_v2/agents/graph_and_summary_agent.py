...
def graph_and_summary_agent(user_input: str, other_agents_response: Any) -> tuple:
    """
    ...
    if not isinstance(other_agents_response, str):
        other_agents_response_str = json.dumps(other_agents_response)
    else:
        other_agents_response_str = other_agents_response
    ...
    try:
        ...
        empty_response["summary"] = f"Error generating summary: {str(e)}"
