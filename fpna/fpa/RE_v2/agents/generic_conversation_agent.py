...
def generic_conversation_agent(function_params: Union[Dict[str, str], List[str]], tools: List[Dict] = None) -> tuple:
    ...
    try:
        ...
        if not tools:
            return f"I understand you mentioned: {input_text}. However, I'm designed to help with data analysis queries. Could you please provide a specific question about your business data?", 0, 0
