...
def validate_request_id(request_id):
    ...
    SELECT 
        *
    FROM 
        SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.API_INGESTION_RESPONSE
    WHERE 
        REQUEST_ID = '{}';
    """.format(request_id)
...
def validate_ask_ellis_api_request_data(data):
    ...
    # 'conversation_history' is optional from some frontend clients; backend can handle default []
    # if conversation_history is not provided in the payload.
